const quotest = ['If you fall asleep now, you will dream. If you study now, you will live your dream.',
...
function generateQuotes(quotest) {
    document.querySelector('.modal p').textContent = quotest[Math.round(Math.random() * quotest.length)]
}
setInterval(generateQuotes, 3000, quotest)